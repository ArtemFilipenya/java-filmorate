...
public class UserDbStorage implements UserStorage {
    ...
    public void saveUser(User user) {
        ...
        jdbcTemplate.batchUpdate(sqlQueryToAddUser, new BatchPreparedStatementSetter() {
            @Override
            public void setValues(PreparedStatement ps, int i) throws SQLException {
                ps.setInt(1, user.getId());
                ps.setObject(2, friendIds.get(i));
            }
    ...
    public void update(User user) {
        ...
        int numberOfRowsUpdate = jdbcTemplate.update(sqlQueryToUpdateUser, user.getEmail(), user.getLogin(),
    ...
    public void deleteFriend(Integer userId, Integer friendId) {
        ...
        jdbcTemplate.update(sqlQueryToDeleteFromFriends, userId, friendId);
    }
